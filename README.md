...
As well as the requirements listed in the challenge, I also added an error modal, wrote unit and integration tests using Vitest and React Testing Library, and
